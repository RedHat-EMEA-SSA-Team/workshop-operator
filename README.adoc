...
There is examples of custom resources (CR) in https://github.com/RedHat-EMEA-SSA-Team/workshop-operator/tree/master/deploy/crds[crds]
...
[source,bash]
----
make docker-build IMG=quay.io/redhat-emea-ssa-team/workshop-operator
make docker-push IMG=quay.io/redhat-emea-ssa-team/workshop-operator
----