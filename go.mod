...
require (
	github.com/eclipse-che/che-operator v0.0.0-20230615115824-94934bfe17fa
	github.com/istio-ecosystem/sail-operator v0.0.0-20251219052726-64dab4cacdc8
...
require (
	...
	github.com/devfile/devworkspace-operator v0.21.0 // indirect
