...
one-deploy-file: manifests kustomize ## Save all parameterized resources into one unique yaml file 
	cd config/manager && $(KUSTOMIZE) edit set image controller=${IMG}
	$(KUSTOMIZE) build config/default > config/deploy/workshop_operator_deployment.yaml
